      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 lg:gap-16 py-16 lg:py-24 items-center">
        ...
        >
          ...
          <form className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-2">
              <Button
                type="submit"
                className="bg-accent hover:bg-[#c2410c] text-white w-full sm:w-auto px-8 py-6 text-base rounded-md shadow-lg shadow-accent/20 transition-all hover:-translate-y-0.5"
              >
                Offerte aanvragen
              </Button>
              <Link
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-6 left-6 right-6 lg:left-auto lg:right-6 lg:w-80 bg-white p-6 rounded-xl shadow-xl border border-slate-100 z-10"
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-slate-600">
                ...
                <Link href="tel:0118461892" className="text-sm font-medium hover:text-primary transition-colors">
                  0118 - 461892
                </Link>
              </div>
            </div>
