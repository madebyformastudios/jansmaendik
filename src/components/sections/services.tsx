          ...
          {servicesList.map((service, idx) => {
            ...
            return (
              <div 
                ...
                className={cn(
                  "relative rounded-2xl p-6 lg:p-8 flex flex-col justify-between transition-all duration-300 group",
                  isActive 
                    ? "bg-white text-slate-900 shadow-2xl scale-[1.02] md:scale-100 lg:scale-[1.03] z-10" 
              ...
              >
                ...
                <div className="relative mt-auto">
                  ...
                  {/* Floating Action Button (overlapping bottom-right corner) */}
                  <Link 
                    href="/diensten"
                    className={cn(
                      "absolute -bottom-4 -right-4 w-14 h-14 bg-accent rounded-full flex items-center justify-center text-white shadow-xl transition-transform hover:scale-110",
